...
<?php if ( true === lsvr_lore_has_footer_social_links() ) : ?>
	...
	<div class="footer-social">
		<ul class="footer-social__list">
			...
			<?php foreach ( lsvr_lore_get_social_links() as $social_link_id => $social_link ) : ?>
				<?php if ( ! empty( $social_link['url'] ) && ! empty( $social_link['icon'] ) ) : ?>
					...
					<li class="footer-social__item footer-social__item--<?php echo esc_attr( $social_link_id ); ?>">
						<a class="footer-social__item-link footer-social__item-link--<?php echo esc_attr( $social_link_id ); ?>" target="_blank"
