 ...
 */
	...
	if ( ! function_exists( 'lsvr_lore_search_filter' ) ) {
		function lsvr_lore_search_filter( $query ) {
			...
			if ( is_search() && $query->is_main_query()
				&& ( isset( $_GET['search-filter'] ) || isset( $_GET['search-filter-serialized'] ) ) ) {
	...
	add_filter( 'lsvr_framework_gutenberg_is_disabled', 'lsvr_lore_gutenberg_is_disabled' );
	if ( ! function_exists( 'lsvr_lore_gutenberg_is_disabled' ) ) {
		function lsvr_lore_gutenberg_is_disabled( $is_disabled ) {
