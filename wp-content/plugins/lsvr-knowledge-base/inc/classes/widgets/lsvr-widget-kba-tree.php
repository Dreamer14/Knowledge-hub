...
class Lsvr_Widget_KBA_Tree extends Lsvr_Widget {
			...
			'fields' => array(
				...
				'post_order' => array(
					...
					'choices' => array(
                        ...
                        'title' => esc_html__( 'By Title', 'lsvr-knowledge-base' ),
    ...
    function widget( $args, $instance ) {
		...
		if ( true === $show_posts && ! empty( $instance['post_order'] ) && 'default' !== $instance['post_order'] ) {
			...
			elseif ( 'title' == $instance['post_order'] ) {
        ...
        <div class="widget__content lsvr_kba-tree-widget__content">
    		...
    		<ul class="lsvr_kba-tree-widget__list lsvr_kba-tree-widget__list--level-0"
    			data-label-expand="<?php esc_html_e( 'Expand', 'lsvr-knowledge-base' ); ?>"
    			data-label-collapse="<?php esc_html_e( 'Collapse', 'lsvr-knowledge-base' ); ?>">
