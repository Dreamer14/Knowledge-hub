...
Contributors:  a.ankit, priyanshu.mittal
Donate link: https://websitebooklet.com
...
For more support visit [HTML5 Responsive FAQ](https://websitebooklet.com/wp-plugins/html5-responsive-faq-plugin-for-wordpress) plugin page. We will be glad to help you.
...
= Configuration: =
      ...
      1. Click 'HTML5 FAQ' menu option in WordPress admin.
...
=2.8.1=
* Fixing of small layout issue

= 2.8 =
* Minor Change

= 2.7.9 =
* Js fix for toggle issue. 
...
= 2.7.1 =
* The settings Panel is now translation ready

= 2.6 =
* User INterface Improvements
* Combined multiple menu items into one
